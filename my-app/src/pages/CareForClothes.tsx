   ...
   <>
     ...
     <FaRecycle />
       ...
       <div className="mending-text-conatiner">
         ...
         <aside className="mending-heading" id="blog-heading">Mending Blog for beginners<span className="space"><FaArrowDown/></span></aside>
       ...
       <h2 className="mending-heading" id="video-heading">Popular Mending Hacks</h2>
